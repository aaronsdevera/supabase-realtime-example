// name: pub.js
// author: @aaronsdevera
// description: inserts a new row into a Supabase table named "countries"
...
// key: "name", value: randomly selected country from list
const ROWDATA = { name: countryList[random] }
...
try {
  ...
  console.log(`[+] Successfully inserted data ${JSON.stringify(ROWDATA)} into table ${TABLE}.`)
} catch (e) {
  console.log(`[!] Error: ${e}`)
}
